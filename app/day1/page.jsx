  ...
  return (
    <main>
      <div>
        ...
        <p>Part two was more confusing because I originally thought about comparing written numbers with actual numbers whilst analysing their character positions, but soon realised I could just replace the written numbers with actual numbers. Had some issues with that because I missed one of the combined word combinations and didn't find it for ages.</p>
        <CodeBlock 
