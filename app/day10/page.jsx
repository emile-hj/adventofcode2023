...
export default function Page() {
  ...
  const realInput = `7-J-..FF.FLJJ7-7-L|7FFF7F7FF..|7-77.F77L---|7L-77-FF.LF-J77F-7L7L7|--.F-|.FFFF-|7-|.F--|FF.F.F77-L7-|7FF.FJ7FLL7-J7-|7|-L7-|7.7FF|-7-F.7777|
    ...
    <main>
      <div>
        <DayHeader
          title='Day 10'
          starCount={1}
          puzzleLink='https://adventofcode.com/2023/day/10'
        />


        <p>On first glance the puzzle reminded me of the flow puzzles from Bioshock, and I've been playing them a lot recently replaying through the first game. I also thought it was going to be very convoluted, but as I thought about it more, I had a fairly straight forward plan. That plan worked, but implementing it was very difficult.</p>
        <p>Yet again I had a lot of trouble with the recursive loop, debugging what would be the end point for it, and many bugs and hiccups along the way. Got there in the end, and I probably spent at least 3.5 hours on it. I think I need to take up Tim's advice to start writing unit tests and learning more about that. So that's on the horizon now for things to learn.</p>
        <p>Looking at part two now – just no. I could probably get there in the end, but I don't have time for it really. It looks very challenging and will likely mean intense computation, so another part of the challenge will be writing a very elegant solution.</p>
        <p>Please note, running the real input in browser could crash it.</p>
